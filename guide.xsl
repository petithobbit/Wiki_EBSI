...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--@todo: pour l'instant l'extrant xml ne permet pas de traiter les différents niveaux de section-->
   ...
   <!--traitement des exposants (superscript) -->
    ...
    <!-- @todo: Plusieurs cas possibles. A discuter avec Arnaud s'il est possible de nettoyer certaines balises vides -->
  ...
  <xsl:template match="table">
   ...
   <xsl:apply-templates/>   
    ...
    <!-- "todo <xsl:variable name="lignes" select="table/tr"> -->
